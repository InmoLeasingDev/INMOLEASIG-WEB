    ...
    with tab5:
        ...
        with tab_lm:
            ...
            if not df_full.empty:
                ...
                # 💡 Volvemos al selectbox con "Todas las cuentas" como primera opción
                cta_sel = c_filtro1.selectbox("🔍 Selecciona la cuenta a auditar:", ["Todas las cuentas"] + opciones_ctas)
